...
- **智能过滤**：三层筛选策略聚焦 AI 相关岗位——① 标题强 AI 信号（大模型/算法/多模态/芯片/语音等）直接保留；② 功能黑名单剔除行政/销售/财务/供应链/电商运营等无关职能；③ 混合型公司（腾讯/字节/Databricks 等）仅保留核心技术岗且需描述含 AI 内容佐证。另支持前端按岗位类别（算法/研究、工程技术、产品、设计）快捷筛选
